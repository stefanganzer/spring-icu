...
class ICUMessageSourceTest {
	...
	private static Stream<Arguments> localesArgs() {
		return Stream.of(Arguments.of(Locale.ENGLISH, "Refresh inbox"),
	...
	private static Stream<Arguments> pluralsArgs() {
		return Stream.of(Arguments.of(1, "Message"), Arguments.of(2, "Messages"));
	}
	...
	private static Stream<Arguments> pluralsExactMatchesArgs() {
		return Stream.of(Arguments.of(0, "No messages"), Arguments.of(1, "1 message"), Arguments.of(2, "2 messages"));
	}
	...
	private static Stream<Arguments> pluralsOffsettingFormArgs() {
		return Stream.of(Arguments.of(0, "Nobody read this message"), Arguments.of(1, "Only you read this message"),
	...
	private static Stream<Arguments> selectArgs() {
		return Stream.of(Arguments.of("male", "He replied to your message"),
	...
	private static Stream<Arguments> ordinalsArgs() {
		return Stream.of(Arguments.of(1, "1st message"), Arguments.of(2, "2nd message"), Arguments.of(3, "3rd message"),
				Arguments.of(4, "4th message"), Arguments.of(5, "5th message"));
	}
	...
	void testDates() {
		...
		java.util.Date date = Date
			.from(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneId.systemDefault()).toInstant());
	...
	void testDefaultMessage() {
		String msg = messageSource.getMessage("nonexistent.message", new Object[] { "not used" }, "default",
				Locale.ENGLISH);
